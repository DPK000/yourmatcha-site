-- ============================================================
-- BUQE Commerce — Eerste setup voor YourMatcha
-- Plak dit hele bestand in https://supabase.com/dashboard/project/exniwwddrdreihvwjokq/sql
-- (New query → paste → Run)
-- ============================================================
...
insert into public.products (
  name, slug, category, price, image,
  description, short_description, sort_order, in_stock
)
values (
  'Ceremoniële Matcha 30g',
  'ceremonial-matcha-30g',
  'main',
  24.95,
  '/src/assets/product-pouch-ceremonial-30.jpg',
  'Premium ceremoniële matcha uit Uji, Japan — eerste BUQE Commerce testproduct.',
  'Premium ceremoniële matcha',
  1,
  true
)
